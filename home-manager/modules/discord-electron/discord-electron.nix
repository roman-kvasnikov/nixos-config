{
  ...
  desktopItem = makeDesktopItem {
    ...
    icon = pname;
    desktopName = "Discord";
    comment = "Discord in Electron";
    categories = ["Network" "InstantMessaging"];
    startupWMClass = "discord-electron"; # Должно совпадать с WM_CLASS
  };
in
  stdenv.mkDerivation rec {
    ...
    installPhase = ''
      ...
      makeWrapper ${electron}/bin/electron $out/bin/${pname} \
        ...
        --set WM_CLASS "discord-electron" \
        --add-flags "--name=discord-electron" \
        --add-flags "--class=discord-electron"
